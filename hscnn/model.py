...
class HSCNN_D_NIR(nn.Module):  # Renombrado para mayor claridad
    def __init__(self, growth_rate=16, num_layers=4):
        ...
        self.final_conv = nn.Conv2d(32 + 2 * growth_rate * num_layers, 1, kernel_size=3, padding=1)  # Cambiado a 1 canal
    ...
    def forward(self, x):
        ...
        x = self.final_conv(x)
        return x  # Output shape: (batch, 1, H, W)
